    ...
    <main className="p-20">
      <article className="prose lg:prose-xl dark:prose-invert">
        ...
        <p>
          ...
          by itself like Kanji, but it represents sounds.
        </p>
        ...
        <p>
          ...
          which have many strokes, but even with kana, such as hiragana,
          it&apos;s important to get accustomed to their distinct shapes,
